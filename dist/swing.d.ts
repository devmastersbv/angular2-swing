...
export declare type ThrowEventName = 'throwin' | 'throwinend' | 'throwout' | 'throwoutend' | 'throwoutleft' | 'throwoutup' | 'throwoutdown' | 'throwoutright';
export declare type DragEventName = 'dragstart' | 'dragmove' | 'dragend';
